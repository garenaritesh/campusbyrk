...
// Fetch Orders 
$order_query = "select * from orders where track_status = 'Shipped'";
...
if (isset($_REQUEST['update_track'])) {
    ...
    if ($track_change_value == 'Out of Delivery') {
        $update_track_query = "update orders set track_status='Out of Delivery' where order_id = '$order_id'";
        mysqli_query($db, $update_track_query);
        header("location: shipped_orders.php");
    } else {
        echo "<script>
...
<body>
    ...
    <div class="orders_tab">
        ...
        <button class="co_tab" onclick="location.href='shipped_orders.php'">Shipped Orders</button>
