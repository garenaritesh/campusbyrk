...
if (isset($_REQUEST['remark_send'])) {
    ...
    $sql2 = "update train_forms set status='Remark' where email = '$email' and train_form_id = '$form_id'";
...
<body>
    ...
    <div class="remark_form">
        ...
        <form action="#" method="post" enctype="multipart/form-data">
            <!-- Data -->
            <input type="text" name="form_id" value="<?php echo $row['train_form_id']; ?>">
            ...
            <button type="submit" name="remark_send">Send</button>
        </form>
