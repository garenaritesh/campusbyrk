...
if (isset($_REQUEST['submit'])) {
    ...
    $ration_card = $_FILES['rationcard']['name'];
    move_uploaded_file($_FILES['rationcard']['tmp_name'], '../admin/images/' . $ration_card);

    $sign = $_FILES['signature']['name'];
    move_uploaded_file($_FILES['signature']['tmp_name'], '../admin/images/' . $sign);

    mysqli_query($db, "insert into bus_forms(full_name,phone,email,dob,age,cast,address,sem,department,gender,departure,destination,months,profile_pic,adhar_card,fees_receipt,i_card,rationcard,signature,status) values('$full_name','$phone','$email','$dob','$age','$cast','$address','$sem','$department','$gender','$departure','$destination','$months','$profile_pic','$adhar','$fees','$i_card','$ration_card','$sign','pending')");

    header("location:busform.php");
...
<div class="forms">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="personal_dtl">
            ...
            <div class="form_group">
                <input type="text" name="age" id="age" placeholder="Enter DOB" required>
        ...
        <div class="identy_dtl">
            ...
            <div class="document">
                <label for="RationCard">
                    <img src="../admin/assets/upload_icon.png" alt="RationCard" id="RationCardPreview">
                    <p>Ration Card</p>
                </label>
                <input type="file" id="RationCard" name="rationcard" accept="image/*">
            </div>
            <div class="document">
                <label for="Signature">
...
<script>
    ...
    document.getElementById('RationCard').addEventListener('change', function () {
        previewFile(this, 'RationCardPreview');
    });
