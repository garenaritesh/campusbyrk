...
if (isset($_POST['send'])) {
    ...
    if ($check_email > 0) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'rkthakre554@gmail.com';
        $mail->Password = 'txwkhutifgvuacvx'; // Your Gmail Password Of Sending Email Id Or Account
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;

        $mail->setFrom('rkthakre554@gmail.com');
